...
.EXAMPLE
    .opencode\task-system\self-modification\dgm-rehearse.ps1 -ProposalFile proposals/dgm-proposal-20260723.json
    .opencode\task-system\self-modification\dgm-rehearse.ps1 -ProposalFile proposals/dgm-proposal-20260723.json -Quick
#>
...
if ($verifyPassed) {
    ...
    Write-Host "    .opencode\task-system\self-modification\dgm-promote.ps1 -ProposalFile $ProposalFile -RehearsalId $RehearsalId" -ForegroundColor Yellow
    Write-Host ""
