...
Not every task needs every skill. A bug fix might only need: `systematic-debugging` → `test-driven-development` → `code-review-and-quality`.
...
| Verify | systematic-debugging | Reproduce → localize → fix → guard |
