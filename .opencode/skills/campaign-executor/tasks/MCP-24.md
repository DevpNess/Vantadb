# Task MCP-24 — Búsqueda avanzada: search_with_method + search_multi/all

**Fuente de verdad:** `docs/Backlog.md` → fase **P25 - Exposición MCP/HTTP** → fila `MCP-24` (leer ANTES de ejecutar: problema, acciones numeradas, archivos exactos).
**Prioridad:** 🟡 · **Esfuerzo:** 🟢

## Fase 1 — DISCOVERY
- [ ] Leer la fila `MCP-24` completa en `docs/Backlog.md`.
