...
> Path resolution: `skills/X` → `.antigravity/skills/X/`, `prompts/X.md` → `.antigravity/task-system/prompts/X.md`
...
3. TRACKING DE SESIÓN:
   ...
   - Si hay harness activo (`.antigravity/task-system/harness/harness-executor.ps1`) → verificar PID con `campaign_mount_harness` (MCP) dry-run antes de empezar
