...
|------|-------------|-----|
| **Entry** | 9 commands en `.antigravity/commands/` | Detectan el intento del usuario, resuelven rutas, orquestan |
...
|---|---|
| `prompts/X.md` | `.antigravity/task-system/prompts/X.md` |
| `skills/X` | `.antigravity/skills/X/` |
| `tasks/<ID>.md` | `.antigravity/skills/campaign-executor/tasks/<ID>.md` |
...
**Archivo:** `.antigravity/commands/pipeline.md`
...
| `run` | `/pipeline run -PlanFile ...` | Inicia .antigravity/task-system/harness/harness-executor.ps1 |
...
**Flujo `run`:**
1. Inicia `.antigravity/task-system/harness/harness-executor.ps1` (loop PowerShell)
2. Por cada tarea: inyecta `iter-loop-tools.md` → agente ejecuta un step → verifica
3. Al completar: commit + `skill progreso`

### 3.2 Audit — `/audit`

**Archivo:** `.antigravity/commands/audit.md`
...
|------------|-----------|-----------|
| **plan.md** | `.antigravity/task-system/prompts/plan.md` | Crear plan desde backlog |
| **task.md** | `.antigravity/task-system/prompts/task.md` | Definir tarea individual |
| **iter-loop-tools.md** | `.antigravity/task-system/prompts/iter-loop-tools.md` | Una iteración del harness |
| **pipeline.md** | `.antigravity/commands/pipeline.md` | Entry point |
| **harness-executor.ps1** | `.antigravity/task-system/harness/harness-executor.ps1` | Loop PowerShell |
| **SKILL.md** | `.antigravity/skills/campaign-executor/SKILL.md` | Referencia completa |
| **RULES.md** | `.antigravity/skills/campaign-executor/RULES.md` | Reglas invariantes |
...
**Ubicación:** `.antigravity/skills/vantadb-certify/SKILL.md` (117 líneas)
...
**Ubicación:** `.antigravity/skills/vantadb-audit/SKILL.md` (121 líneas)
...
**Ubicación:** `.antigravity/skills/vantadb-full-review/SKILL.md` (970 líneas)
...
**Ubicación:** `.antigravity/skills/review-deep/SKILL.md` (370 líneas) + `loop-prompt.md` (71 líneas)

**Diferencia con full-review:** No es one-shot. Es un loop que corre tantas iteraciones como módulos tenga el proyecto.

**Arquitectura:**
```
/loop-goal --prompt-file .antigravity/skills/review-deep/loop-prompt.md "MODULE=..."
  │
...
**Ubicación:** `.antigravity/skills/progreso/SKILL.md` (112 líneas)
...
**Ubicación:** `.antigravity/skills/campaign-executor/SKILL.md` (334 líneas) + `RULES.md` (228 líneas)

**Relaciones con otros componentes:**
| Componente | Relación |
|------------|----------|
| `AGENTS.md` | Path resolution: `tasks/<ID>.md` → `.antigravity/skills/campaign-executor/tasks/<ID>.md` |
...
4. **Un paso por turno** — Antigravity opera por turnos. Cada turno ejecuta UNA acción atómica. El harness itera por vos.
...
|---------|-------|----------|
| El agente hace 2+ tareas en un turno | Ignoró "una iteración" | Usar el harness (`.antigravity/task-system/harness/harness-executor.ps1`) |
...
| Skill no encontrada | Ruta incorrecta | Verificar que existe en `.antigravity/skills/<name>/SKILL.md` |
...
| Término | Definición |
|---------|-----------|
| **Command** | Entry point del usuario (`.antigravity/commands/*.md`). Detecta intento, resuelve rutas, orquesta |
| **Skill** | Workflow especializado (`.antigravity/skills/<name>/SKILL.md`). Pasos + criterios de salida |
| **Prompt** | Instrucción detallada para el agente (`.antigravity/task-system/prompts/*.md`) |
| **Agent** | Rol con perspectiva y herramientas restringidas (`.antigravity/agents/*.md`) |
...
| **Harness** | Loop externo PowerShell (`.antigravity/task-system/harness/harness-executor.ps1`). Timeout, git check, sync |
...
raíz/
  .antigravity/task-system/harness/harness-executor.ps1  ← Loop PowerShell
  docs/
