...
**References:**
- `.antigravity/references/performance-checklist.md` — CWV targets, TTFB diagnosis, backend checklist
- `.antigravity/references/observability-checklist.md` — structured logging, metrics, tracing, alerting, pre-launch gate
