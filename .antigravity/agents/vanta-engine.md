...
**References:**
- `.antigravity/references/testing-patterns.md` — patrones de benchmarks y assertions
...
| **metasearchmcp** | ❌ | Web search multi-provider (no relevante para engine) |
| **argus** | ❌ | URL content extraction (no relevante para engine) |
