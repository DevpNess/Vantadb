...
**References:**
- `.antigravity/references/testing-patterns.md` — patrones AAA, mocking, naming para tests de bindings
- `.antigravity/references/definition-of-done.md` — standing quality bar para todo cambio
...
| **argus** | ❌ | URL content extraction (no relevante para worker) |
