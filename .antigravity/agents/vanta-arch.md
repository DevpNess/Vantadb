...
**References:**
- `.antigravity/references/orchestration-patterns.md` — patrones de orquestación entre módulos
- `.antigravity/references/definition-of-done.md` — standing quality bar para ADRs y cambios arquitectónicos
