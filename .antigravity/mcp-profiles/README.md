...
.antigravity/mcp-profiles/switch-profile.ps1 -Profile design

# Volver a full (todo habilitado)
.antigravity/mcp-profiles/switch-profile.ps1 -Profile full

# Ver qué perfiles existen
.antigravity/mcp-profiles/switch-profile.ps1 -List
```
