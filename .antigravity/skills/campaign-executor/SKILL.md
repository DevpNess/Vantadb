...
|------------|-----------|-----------|
| **plan.md** | `prompts/plan.md` → `.antigravity/task-system/prompts/plan.md` | Crear plan desde backlog |
| **task.md** | `prompts/task.md` → `.antigravity/task-system/prompts/task.md` | Definir tarea individual |
| **iter-loop-tools.md** | `prompts/iter-loop-tools.md` → `.antigravity/task-system/prompts/iter-loop-tools.md` | Prompt único del harness (1 iteración) |
| **pipeline.md** | `.antigravity/commands/pipeline.md` | Entry point: backlog / task ID / run |
| **harness-executor.ps1** | `.antigravity/task-system/harness/harness-executor.ps1` | Loop PowerShell (timeout, git check, sync) |
| **Plan file** | `docs/plans/<fecha>-<nombre>.md` | Orquestación: qué tasks, en qué estado |
| **Task file** | `tasks/<ID>.md` (resuelve a `.antigravity/skills/campaign-executor/tasks/<ID>.md`) | Profundidad: steps atómicos, blast radius |
...
2. `pipeline.md` carga `.antigravity/task-system/prompts/plan.md`
...
1. Harness encuentra tarea ⬜ PENDING, inyecta `.antigravity/task-system/prompts/iter-loop-tools.md`
...
7. Crea `tasks/<ID>.md` (`.antigravity/skills/campaign-executor/tasks/<ID>.md`) con steps, contrato, herramientas
...
1. Harness re-inyecta `.antigravity/task-system/prompts/iter-loop-tools.md`
...
/pipeline run                    → .antigravity/task-system/harness/harness-executor.ps1 + iter-loop-tools.md
```
...
/pipeline plan docs/Backlog.md
  ...
  │
  ├─ .antigravity/task-system/harness/harness-executor.ps1
  │   │
