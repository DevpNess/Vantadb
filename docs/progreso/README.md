...
| `PERF-03` | Bench competitivo honesto de SDKs: harness `benchmarks/competitive_bench.py` extendido (Qdrant local + Milvus-lite wireado, Chroma/Lance) mide en mismo HW; publica `docs/benchmarks/COMPETITIVE_SDK_BENCH.md` con números reales — hallazgo honesto: VantaDB Recall@10 59.2% vs Qdrant 100%/Chroma 97.6% (pierde en recall, gana en QPS). Milvus pendiente de `pip install milvus-lite`. Commit `437a1125` | 🟠 | ✅ 2026-08-12 |
