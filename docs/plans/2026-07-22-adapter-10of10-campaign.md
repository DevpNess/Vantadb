...
Wave 2 (ADP-01..05) ──┤
                       ├──→ Wave 3 (PRV-04..06) ──┐
                       │                           ├──→ Wave 4 (TST-01..04) ──┐
                       │                           │                         ├──→ Wave 6 (DOC-01..02) ──→ Wave 7
                       ├──→ Wave 5 (FTR-01..03) ──┘                         │
                       └──→ (independiente) ────────────────────────────────┘
```

Las Waves 1 y 2 son independientes y pueden correr en paralelo.
Waves 3, 4, 5 dependen de Waves 1-2. Wave 6 depende de Wave 4.
Wave 7 es el cierre final.
