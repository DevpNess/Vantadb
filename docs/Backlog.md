...
| `OLD-05` | **Search Quality v2 (Unicode + snippets)** — Tokenizer avanzado, Unicode folding existe. Snippet generation en TS SDK | 🟡 3-4d | ⚠️ Parcial (tokenizer OK, snippets públicos no) | Ninguna. Continuación de TSK-123 | 🗺️ Roadmap |
