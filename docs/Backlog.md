...
> **Total open items:** 49 activas (conteo real 2026-08-24, filas pendientes; regla GOV-C7: actualizar contando filas pendientes en cada sync) — **Sync 2026-08-24 campaña desktop: 16 tareas DESKTOP ejecutadas (23..37,39 — ver `docs/avance/activo/desktop.md`), filas eliminadas** — previas (DISC-01..03, LEG-01, BIZ-01b, OLD-01, DESKTOP-15..27, [ADMIN-XX pending W4]) + P15 residuales (ERR-006/007/008/009/015/026/031/032/033/036/037/042/043/044/045/047/048/049) + P16 residuales (PERF-07/08/09, CI-01) + **P25 (MCP-16..26) + P26 (VS-00..11 + VS-CORE-01..07)**. P15/P16 principales ejecutadas por plan `docs/plans/archive/2026-08-09-backlog-pipeline.md` (49/49 ✅). P19 CI batch (CI-02..07) ejecutado y migrado 2026-08-12 — plan archivado `docs/plans/archive/2026-08-12-ci-deuda.md`. Origen: investigación multi-agente 2026-08-09 → `docs/research/investigacion-equipo-2026-08-09.md`
...
| **P12** 🖥️ DESKTOP App (Tauri) + Consola Admin | **1 pendiente (DESKTOP-38, bloqueada por endpoint metrics de vanta-proxy)** — campaña 2026-08-24: DESKTOP-23..37 + 39 ejecutadas (16/17) y migradas a `docs/avance/activo/desktop.md`; ADMIN-01..09 + DESKTOP-20 ✅; resto archivadas por P26 | — | 🟡 Casi cerrada |
