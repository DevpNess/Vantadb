...
| `FIND-28` | 🟢 | Mismo patrón unsafe→align_to que REVIEW-15 arregló en vector_data.rs:167 — 3 sitios hermanos con cast manual u8*→f32* sin prueba de alineación | `src/index/ivf.rs:69`, `src/storage/engine/mapper.rs:191`, `src/sdk/serialization/bytes.rs:136` · hallazgo review REVIEW-15 2026-08-23 | ❌ Pendiente |
