...
| `TIR-03` | **Mitigación/contención primero en incidentes** - no hay fase de contención antes del fix; RULES.md:207 exige "causa raíz primero" (Iron Law) pero no "contener el daño antes de arreglar". Investigar si el pipeline necesita un paso de contención (revert/rollback parcial, detener ingestión) para incidentes 🔴 antes de investigar raíz. | gap-01-agents.md FALTA#15; REPORTE-FINAL §3.3-15 | Flujo de bugs/incidentes + subagent-recovery.md | 🟢 | 🔴 | 🟢 Pendiente (investigación/decision) |
