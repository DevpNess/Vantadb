...
| `WEB-04` | **Metadata i18n consistente**: títulos EN con descripciones/openGraph ES mezclados en layouts about/* y playground — unificar idioma por locale (tt() o claves duales en dictionaries). Origen: INV-web-01 H-02 | `web/src/app/playground/layout.tsx:4-10`, `web/src/app/about/*/layout.tsx` | 🟢 | 🟢 Baja | ⬜ Pendiente |
...
| `WEB-06` | **Instalación más prominente**: bloque comando instalable copiable arriba del fold (home o /docs#quickstart) — patrón milvus/chroma; NO recrear ruta /quickstart (decisión WDA cerrada). Origen: INV-web-01 H-11 | `web/src/app/page.tsx`, `web/src/app/docs/page.tsx` | 🟢 | 🟢 Baja | ⬜ Pendiente |
