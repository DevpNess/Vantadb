...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand tui" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTA_DB environment variable, or \'./db\' if neither is set' -r
