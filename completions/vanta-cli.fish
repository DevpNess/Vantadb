...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "put" -d 'Save a key-value pair to persistent memory'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "get" -d 'Retrieve a value from persistent memory'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "list" -d 'List keys and values in a namespace'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "rebuild-index" -d 'Rebuild all database indexes (HNSW, text index, derived indexes)'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "audit-index" -d 'Validate text index integrity without repairing'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "repair-text-index" -d 'Repair text index if inconsistencies are detected'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "export" -d 'Export records to a JSON file'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "import" -d 'Import records from a JSON file'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "query" -d 'Execute a structured query (IQL/hybrid)'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "status" -d 'Display database health diagnostics and system status'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "backup" -d 'Create a filesystem-level backup of the database directory'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "restore" -d 'Restore the database from a previously created backup directory'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "doctor" -d 'Run comprehensive health diagnostics on the database'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "inspect" -d 'Inspect a single record showing all fields, vectors, and metadata'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "stats" -d 'Display detailed database statistics in human-readable or JSON format'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "completions" -d 'Generate shell completion scripts'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "search" -d 'Search records semantically across a namespace'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "delete" -d 'Delete a record by namespace and key'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "migrate" -d 'Migrate a database to the latest storage schema version'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "namespace" -d 'Manage namespaces'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "snapshot" -d 'Manage instant filesystem snapshots'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "wal" -d 'Manage the Write-Ahead Log (compact, vacuum)'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "server" -d 'Start the HTTP or MCP server wrapper'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and not __fish_seen_subcommand_from put get list rebuild-index audit-index repair-text-index export import query status backup restore doctor inspect stats completions search delete migrate namespace snapshot wal server help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
